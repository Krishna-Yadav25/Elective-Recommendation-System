...
<title>Add Email — Elective System</title>
<style>
...
.card-sub{font-size:13px;color:#9ca3af;margin-bottom:28px;line-height:1.6;}
.notice{background:#EEEDFE;border:1px solid #c4bff5;border-radius:9px;padding:12px 14px;margin-bottom:20px;font-size:13px;color:#534AB7;line-height:1.5;}
...
<div class="card">
    ...
    <div class="card-title">One quick step!</div>
    <div class="card-sub">We need your email address to keep your account secure and help you recover your password if needed.</div>

    <div class="notice">
        📧 This is a one-time setup. You won't be asked again after this.
    </div>
